...
lit review section total words: #total.words. work still to be done to tie the literature together more
...
In Brazil, they found that there is disproportionate access to learning materials all over the country for learning English compared to Portuguese. It has been noted that the implementation of technology to promote the learning of indigenous languages (which may be endangered) must be placed in the proper context, with regard to the challenges and history @bodah_challenges_2016.
