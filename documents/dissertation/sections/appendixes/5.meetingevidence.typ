...
#[
  ...
  - Get interim meeting date sorted (for next week)

  === Progress
  - Good progress on literature review, lots of sections filled out
  - Sources found and most cited in the literature review

  === Supervisor Comments
  - Shared useful papers & Gaidhlig LLM research
  - Shared a good book to help with learning Gaidhlig
  - Started setting up interim meeting
